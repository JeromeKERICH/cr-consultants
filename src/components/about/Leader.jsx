          ...
          >
            ...
            <div className="text-center lg:text-left w-full">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 mb-6">
                <a href="https://www.linkedin.com/in/princess-c-mutisya/" className="flex items-center text-gray-600 hover:text-secondary transition-colors px-3 py-1 bg-white rounded-full shadow-sm text-sm">
              ...
              <div className="flex justify-center lg:justify-start space-x-4">
                <a href="https://www.linkedin.com/newsletters/7316476760437497856/?displayConfirmation=true" className="bg-white p-2 rounded-lg shadow hover:bg-gray-100 transition-colors flex items-center">
